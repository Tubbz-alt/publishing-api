...
RSpec.describe "Date range rake tasks" do
  describe "publishings" do
    let(:task) { Rake::Task["date_range:publishings"] }
  ...
  describe "unpublishings" do
    let(:task) { Rake::Task["date_range:unpublishings"] }
    before { task.reenable }
